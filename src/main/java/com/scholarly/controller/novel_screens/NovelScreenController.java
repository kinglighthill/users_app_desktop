...
import com.scholarly.data.model.novels.NovelCategoryGenre;
import com.scholarly.data.model.novels.NovelModel;
import com.scholarly.ui.cellFactories.NovelListCellFactory;
...
import com.scholarly.viewmodels.novel_screens.NovelScreenVM;
...
import static com.scholarly.util.Constants.PREF_KEY_DONT_SHOW_NOVEL_SCREEN_PROMPT;
...
public class NovelScreenController implements FxmlView<NovelScreenVM>, Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        viewModel.getNovelsLoaded().addListener((mObservable, mOldValue, mNewValue) -> {
