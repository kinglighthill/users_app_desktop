...
import com.scholarly.ui.cellFactories.NoteContentListCellFactory;
import com.scholarly.ui.utils.*;
import com.scholarly.viewmodels.note_screens.NotesScreenVM;
...
//        });
    ...
    private Dialog<String> createNoteDialog(String note) {
        ...
        stage.getIcons().add(new Image(this.getClass().getResource("/drawable/app_icon.png").toString()));
