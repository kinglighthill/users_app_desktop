...
import com.scholarly.ui.cellFactories.TestPerformanceListCellFactory;
...
import com.scholarly.viewmodels.landing_screens.LandingScreenPerformanceVM;
...
public class LandingScreenPerformanceController implements FxmlView<LandingScreenPerformanceVM>, Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        PQSubject subject = new PQSubject(3, 445, 30, 1, "English Language", "Eng", null, null, false);
        ...
        ResultScreenController.InitialData performance1 = new ResultScreenController.InitialData(results, subjects, null, subjectQuestions, null, View.LANDING_SCREEN);
