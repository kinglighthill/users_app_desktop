...
import com.scholarly.network.model.request.UserRequest;
...
import com.scholarly.viewmodels.AuthenticationScreenVM;
...
import static com.scholarly.network.model.DeviceInfo.getSystemProperties;
...
public class AuthenticationController implements FxmlView<AuthenticationScreenVM>, Initializable {
        ...
        try {
            ...
            signUpProceedButton.setOnAction(event -> {
                ...
                UserRequest signupRequest = new UserRequest(
                        fullName, email, phoneNumber, password, COUNTRY, "fcm-token",
                        AppProperties.getInstance().getAppSlug(), false,
                        null, getSystemProperties(), referrerInfo
                );
            ...
            loginProceedButton.setOnAction(event -> {
                ...
                loginRequest.setAppSlug(AppProperties.getInstance().getAppSlug());
            ...
            recoverProceedButton.setOnAction(event -> {
                if (!recoverEmailField.getText().contains("@")) {
                    ...
                    request.setAppSlug(AppProperties.getInstance().getAppSlug());
    ...
    private void signupUser(String authCode, String redirectUri, ServerCallback callback) {
        ...
        GoogleUser user = new GoogleUser(
                COUNTRY, "fcm-token", AppProperties.getInstance().getAppSlug(),
                authCode, redirectUri, getSystemProperties(), referrerInfo
        );
