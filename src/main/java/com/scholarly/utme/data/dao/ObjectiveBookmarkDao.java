...
//        String sql = "SELECT * FROM bookmarks_objective_questions";
    ...
    private static void insertBookmark() {
        long id = CRUDHelper.create(BOOKMARKS_OBJECTIVE_QUESTION,
                new String[]{
                        "subject_id",
                        "year_id",
                        "question_id"
        ...
        System.out.println(TAG + "Bookmark inserted with id -> " + id);
