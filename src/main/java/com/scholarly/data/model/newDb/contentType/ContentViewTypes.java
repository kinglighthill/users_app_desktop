package com.scholarly.data.model.newDb.contentType;

import com.google.gson.Gson;
import com.scholarly.data.model.newDb.Section;
import com.scholarly.data.model.newDb.contentType.audio.AudioViewType;
import com.scholarly.data.model.newDb.contentType.cbt.CBTViewType;
import com.scholarly.data.model.newDb.contentType.html.HtmlViewType;
import com.scholarly.data.model.newDb.contentType.image.ImageViewType;
import com.scholarly.data.model.newDb.contentType.orderedList.OrderedListViewType;
import com.scholarly.data.model.newDb.contentType.table.TableViewType;
import com.scholarly.data.model.newDb.contentType.tablehh.TableHHViewType;
import com.scholarly.data.model.newDb.contentType.text.TextViewType;
import com.scholarly.data.model.newDb.contentType.unorderedList.UnorderedListViewType;
import com.scholarly.data.model.newDb.contentType.video.VideoViewType;
import com.scholarly.data.model.newDb.contentType.webview.WebViewType;
